...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    ...
    <title>预览</title>
    <link rel="stylesheet" href="${ctxStaticModern}/weboffice/pdf.js/viewer.css"/>
    <script src="${ctxStaticModern}/weboffice/pdf.js/compatibility.js"></script>
	<link rel="resource" type="application/l10n" href="${ctxStaticModern}/weboffice/pdf.js/locale/locale.properties"/>
	<script src="${ctxStaticModern}/weboffice/pdf.js/l10n.js"></script>
	<script src="${ctxStaticModern}/weboffice/build/pdf.js"></script>
	<script type="text/javascript">
	 	var ctxStaticModern = '${ctxStaticModern}';
	  	var DEFAULT_URL = '${filePreview.obj}';
	</script>
    <script src="${ctxStaticModern}/weboffice/pdf.js/viewer.js"></script>
  </head>
  <body tabindex="1">
...
<div id="mozPrintCallback-shim" hidden>
  <style scoped>
	...
	#openFile,#print,#download,#viewBookmark {
		display: none;
	}
  </style>
