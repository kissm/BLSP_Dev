...
<script>
	...
	function selectBlspTzjs(){
		openWindow({
			id:'blspTzjs',
			title:'并联审批项目信息',
			url:'${ctx}/project/plusadd/getBlspList?prjType=2',
			width:'900px',
			height:'560px',
						...
						<div role="tabpanel"
							...
							<c:if test="${project.prjInstanceVo.id == null}">
								<div class="col-xs-12 form-group">
									<button type="button" class="btn btn-info btn-sm"  onclick="selectWsbsTzjs();" style="width:154px;">调取网厅项目信息</button>&nbsp;&nbsp;
									<button type="button" class="btn bgm-deeporange btn-sm" onclick="selectBlspTzjs();" style="width:154px;">调取并联审批项目信息</button>&nbsp;&nbsp;
										<%--TODO sharedInformationReuse--%>
							...
							<form method="post" name="form1" id="form1" action="${ctx}/project/bizaccept/basic/">
								...
								<div class="row">
									...
									<div class="col-xs-6 form-group">
										...
										<div class="fg-line">
											<%--TODO checkShengPrjCode 注掉就不验证项目编号--%>
											<c:if test="${fns:getDictValue('sheng_code_switch', 'sheng_code_switch', '0') eq '1'}">
									...
									<div class="col-xs-3 form-group">
										...
										<div class="fg-line">
											<input type="text" name="prjInstanceVo.company" maxlength="200"
												class="form-control " id="company" value="${project.prjInstanceVo.company}" placeholder="建设单位">
										</div>
									</div>
									<div class="col-xs-1 form-group">
										<label class="control-label"></label>
									...
									<div class="col-xs-4 form-group">
										...
										<div class="fg-line">
											<input type="text" class="form-control " id="companyAddr" maxlength="200"
									...
									<div class="col-xs-4 form-group">
										...
										<div class="fg-line">
											<input type="text" class="form-control " id="legalEntity" maxlength="50"
									...
									<div class="col-xs-4 form-group">
										...
										<div class="fg-line">
											<input type="text" class="form-control " id="prjNature"
									...
									<div class="col-xs-4 form-group">
										...
										<div class="fg-line">
											<input type="text" class="form-control " id="prjAddr" maxlength="50"
									...
									<div class="col-xs-4 form-group">
										...
										<div class="fg-line">
											<input type="text" id="prjFloorSpace"
									...
									<div class="col-xs-4 form-group">
										...
										<div class="fg-line">
											<input type="text" id="prjRedlineSpace"
												class="form-control " maxlength="300" isEidt="isEidt"
									...
									<div class="col-xs-6 form-group">
										...
										<div class="fg-line">
											<input type="text" class="form-control " maxlength="300" isEidt="isEidt"
												value="${project.prjInstanceVo.investEstimate}" id="investEstimate"
