...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			if ('${article.category.id}' == 14010) {
				$('#posidList3').parent().hide();
			}
		});
	</script>
</head>
<body>
	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="category" name="category.id" value="${article.category.id}" labelName="category.name" labelValue="${article.category.name}"
					title="栏目" url="/cms/category/treeData" module="article" selectScopeModule="true" notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="required" extId="120"/>&nbsp;
                <span>
		...
		<c:if test="${article.category.id eq '13020' or article.category.id eq '14010'}">
			<div class="control-group">
