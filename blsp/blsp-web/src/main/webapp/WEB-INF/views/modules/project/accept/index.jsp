		...
		<div class="card">
			...
			<div class="card-body card-padding">
				<div class="row">
					...
					<div class="col-sm-12 form-group">
						<label class="control-label col-xs-3">建设类型：</label>
						<label class="radioBox">
					...
					<div class="col-sm-3 form-group">
						<button type="submit" class="btn btn-primary waves-effect form-control">下一步</button>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="card">
				...
				<div class="card-body card-padding">
					<div class="form-group fg-float">
						...
						<label class="fg-label">区项目编号：</label>
					</div>
					<div class="form-group fg-float">
						<div class="fg-line">
