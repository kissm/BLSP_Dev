...
<body>
	...
	<form:form id="inputForm" modelAttribute="link" action="${ctx}/cms/link/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="hidden" id="image" name="image" value="${link.image}" htmlEscape="false" maxlength="255" class="input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="hidden" id="thumImage" name="thumImage" value="${link.thumImage}" htmlEscape="false" maxlength="255" class="input-xlarge"/>
				<sys:ckfinder input="thumImage" type="images" uploadPath="/cms/link" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
