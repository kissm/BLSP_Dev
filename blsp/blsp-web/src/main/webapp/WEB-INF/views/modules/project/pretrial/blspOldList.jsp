...
<html>
    ...
    <body>
        <div class="p-20">
            <form:form role="form" id="searchForm" modelAttribute="blspPrjInstanc" action="${ctx}/project/plusadd/getOldBlspList?prjType=${blspPrjInstanc.prjType}" method="post">
                    ...
                    <div id="clearQuery" class="row">
                        <div class="col-sm-6 form-group">
                            <div class="fg-line">
                                ...
                                <form:input path="prjCode" class="form-control"/>
                            </div>
                        </div>
            ...
            <table id="contentTable"
                ...
                <c:forEach items="${page.list}" var="blspPrj" varStatus="i">
                    <tr>
                        <td>${i.index + 1}</td>
                        <td>
                            <c:if test="${blspPrjInstanc.prjType eq 1}">
                                <a href="${ctx}/project/view?id=${blspPrj.id}" target="_blank">${blspPrj.prjCode}</a>
                            </c:if>
                            <c:if test="${blspPrjInstanc.prjType eq 2}">
                                <a href="${ctx}/enterprise/project/view?id=${blspPrj.id}" target="_blank">${blspPrj.prjCode}</a>
                            </c:if>
                        </td>
