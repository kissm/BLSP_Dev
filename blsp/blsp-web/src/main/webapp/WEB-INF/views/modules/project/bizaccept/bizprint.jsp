...
<script>
	function tijiao() {
		...
		if(typeof(d) == "undefined"){
			window.location.href = "${ctx}/project/bizaccept/print?id=${project.prjInstanceVo.id}&name=受理反馈通知书.doc&taskIds="+ taskIds;
		}else{
			window.location.href = "${ctx}/project/bizaccept/print?id=${project.prjInstanceVo.id}&name=受理反馈通知书.doc&date="+ d +"&taskIds="+ taskIds;
		}
	}
</script>
</head>
