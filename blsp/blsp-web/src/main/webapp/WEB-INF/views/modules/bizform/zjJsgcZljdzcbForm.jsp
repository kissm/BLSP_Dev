...
<body>
	<div class="card">
    	<div class="card-header">
        	<h2>建设工程质量监督注册表<small>您可通过本功能进行建设工程质量监督注册表申报</small></h2>
	        <ul class="actions">
	            <li>
	                <button data-toggle="tooltip" data-placement="bottom" type="button"
    	...
    	<form id="zjJsgcZljdzcbForm" action="${ctx}/zjJsgcZljdzcb/save" method="post">
	    	<div class="card-body card-padding">
	    		<table class="editTable">
	    			<tr height="50px">
	    				<td colspan="14" class="title" style="text-align: left;font-size: 18px;font-weight: 800;">
	    					一、工程概况
	    				</td>
	    			</tr>
	    			<tr height="50px">
	    			...
	    			<tr height="50px">
	    				...
	    				<td colspan="6" style="padding-left: 10px;">
	    					地上：<input class=" base" maxlength="50" style="width:100px;height: auto;border-bottom: 1px solid #ccc;" type="text" value="${formObject.strLevNumOn}" name="strLevNumOn" />
	    					<br/>
	    			...
	    			<tr height="80px">
	    				...
	    				<td colspan="2" style="padding-left: 10px;border-right: none;">
	    					<div class="dtp-container dropdown">
								<input type="text" class="date-picker  base" data-toggle="dropdown" aria-expanded="false" value='<fmt:formatDate value="${formObject.planDurationStart}" pattern="yyyy-MM-dd" />' name="planDurationStart" />
							</div>
	    				</td>
	    				...
	    				<td colspan="2" style="padding-left: 10px;border-left: none;">
	    					<div class="dtp-container dropdown">
								<input type="text" class="date-picker  base" data-toggle="dropdown" aria-expanded="false" value='<fmt:formatDate value="${formObject.planDurationEnd}" pattern="yyyy-MM-dd" />' name="planDurationEnd" />
							</div>
	    				</td>
	    			</tr>
	    			<tr>
	    			...
	    			<tr>
	    				...
	    				<td colspan="12" style="padding-left: 10px;" height="80px">
							...
							<input maxlength="200" class="base" style="width:300px;height: auto;border-bottom: 1px solid #ccc;" type="text" value="${formObject.decMunRoadOther}" name="decMunRoadOther" />
							<br/>
	    			...
	    			<tr>
	    				<td colspan="12" style="padding-left: 10px;" height="100px">
							...
							<input maxlength="200" class="base" style="width:300px;height: auto;border-bottom: 1px solid #ccc;" type="text" value="${formObject.decMunBuildOther}" name="decMunBuildOther" />
							<br/>
	    			...
	    			<tr height="50px">
	    				...
	    				<td colspan="12" style="padding: 0 10px;">
	    					<div class="fg-line">
								<textarea maxlength="200" class="form-control auto-size base" placeholder="请输入..." name="notions">${formObject.notions}</textarea>
							</div>
	    				</td>
	    			</tr>
	    		</table>
	    	...
	    	<%-- 建设单位组织架构 --%>
	   		<div class="card-body card-padding">
	    		<table class="editTable">
	    			<tr>
	    				<td colspan="6" class="title" style="text-align: left;font-size: 18px;font-weight: 800;">
	    					二、建设单位工程项目质量管理组织架构
	    				</td>
	    			</tr>
	    			<tr>
    		...
    		<div class="card-body card-padding">
    			<table class="editTable">
    				<tr>
	    				<td colspan="11" class="title" style="text-align: left;font-size: 18px;font-weight: 800;">
	    		...
	    		<div class="col-xs-4 form-group">
	                ...
	                <div class="fg-line">
	                    <input type="text" class="form-control  base"
	                           ...
	                           name="company" placeholder="建设单位名称">
	                </div>
	            </div>
	    		<div class="col-xs-4 form-group">
		        	<label class="control-label">建设单位日期：</label>
	            	<div class="input-group">
						<span class="input-group-addon"><i class="md md-event"></i></span>
	                    <div class="dtp-container dropdown fg-line ">
	                    	<input type="text"
	                         class="form-control date-picker  base"
	                         data-toggle="dropdown" name="buildUnitDate"
	                         value='<fmt:formatDate value="${formObject.buildUnitDate}" pattern="yyyy-MM-dd" />'
	                         placeholder="单击此处..." aria-expanded="false">
	                     </div>
	                 </div>
		         </div>
		         <div class="col-xs-4 form-group">
		        	<label class="control-label">监理单位日期：</label>
	            	<div class="input-group">
						<span class="input-group-addon"><i class="md md-event"></i></span>
	                    <div class="dtp-container dropdown fg-line ">
	                    	<input type="text"
	                         class="form-control date-picker  base"
	                         data-toggle="dropdown" name="supUnitDate"
	                         value='<fmt:formatDate value="${formObject.supUnitDate}" pattern="yyyy-MM-dd" />'
	                         placeholder="单击此处..." aria-expanded="false">
	                     </div>
	                 </div>
		         </div>
		         <div class="col-xs-4 form-group">
		        	<label class="control-label">施工单位日期：</label>
	            	<div class="input-group">
						<span class="input-group-addon"><i class="md md-event"></i></span>
	                    <div class="dtp-container dropdown fg-line ">
	                    	<input type="text"
	                         	   class="form-control date-picker  base"
	                         	   data-toggle="dropdown" name="conUnitDate"
	                         	   value='<fmt:formatDate value="${formObject.conUnitDate}" pattern="yyyy-MM-dd" />'
	                         	   placeholder="单击此处..." aria-expanded="false">
	                     </div>
	                 </div>
		         </div>
