...
function dateSwitch(obj,type){
	...
	this.location.href="${ctx}/project/report/report?type=2&dType="+type+"&reportDate="+reportDate;
}
...
<body>
			...
			<div class="row">
				<div role="tabpanel" class="tab">
					<ul class="tab-nav" role="tablist" tabindex="3"
						...
						<li><a href="${ctx}/project/report/report?type=1&dType=${dType}">政府项目</a></li>
						<li class="active"><a href="${ctx}/project/report/report?type=2&dType=${dType}">企业项目</a></li>
					</ul>
					...
					<div class="chart m-t-10 m-b-10 p-t-25 p-b-25 ">

						<div class="h4 text-center m-0 m-b-20">
						...
						<div class="clearfix company">
							<div class="col-sm-2">
								<div class="max-round small bgm-deeporange">
									<div class="d-round d-r-t bgm-deeporange"
										onClick="project(${type},${dType},1)">
										新项目<br />受理 <i class="m-r-counts bgm-orange">${report.acceptNum}</i>
									</div>
									<div class="d-round d-r-b bgm-deeporange" onClick="project(${type},${dType},3)">
										阶段类<br />受理<i class="m-r-counts bgm-orange">${report.pendingNum}</i>
									</div>
									受理的数量
								</div>
							</div>
							<div id="chart_id" class="col-sm-8 clearfix">
								<c:forEach items="${report.projectStageVoList}" var="stage" varStatus="c">
									<div class="node bgm-c-${c.index}">
										<div class="node-t">
											${stage.stageName} <i class="m-r-counts bgm-orange">${stage.pendingNum}</i>
										</div>
													...
													<c:forEach items="${task.value}" var="taskvo" varStatus="v">
														<div class="dropdown l-item">
															<div class="dropdown-toggle" data-toggle="dropdown"
																 type="${type}" dType="${dType}" taskid="${taskvo.taskid}">
																	${taskvo.taskName}</div>
	...
	<div class="modal fade" data-modal-color="cyan" id="modal"
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div style="height: 400px;">
					<iframe id="modalContent" width="100%" height="100%"
