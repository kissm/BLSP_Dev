...
<body>
	<div class="card">
    	<div class="card-header">
        	<h2>珠海市建设用地申请表<small>您可通过本功能进行珠海市建设用地申请表申报</small></h2>
	        <ul class="actions">
	            <li>
	                <button data-toggle="tooltip" data-placement="bottom" type="button"
	                 ...
	                 <table class="editTable">
	                 	<tbody>
	                 		...
	                 		<tr id="bui" class="bui" name="buiTr">
	                 			<td>
	                 				<button type="button" onclick="addBuiRow('bui')" class="btn btn-primary"><i class="md md-add"></i></button>
	                 			</td>
	                 			<td>
	                 		...
	                 		<c:forEach items="${formObject.buiList}" var="bui" varStatus="i">
	                 			...
	                 			<c:if test="${i.index > 0}">
	                 				<tr id="bui${bui.bId}" class="bui">
			                 			...
			                 			<td>
			                 				<button type="button" onclick="removeBuiRow('bui${bui.bId}')" class="btn btn-danger"><i class="md md-clear"></i></button>
			                 				<input type="hidden" name="gId" value="${bui.gId}" />
			                 			</td>
			                 			<td>
			                 				<input maxlength="200" type="text"  name="bBuildPrj" value="${bui.bBuildPrj}"/>
	                 		...
	                 		<c:forEach items="${formObject.metList}" var="met" varStatus="i">
	                 			...
	                 			<c:if test="${i.index > 0}">
	                 				<tr id="met${met.dId}" class="met">
			                 			<td>
			                 				<button type="button" onclick="removeMetRow('met${met.dId}')" class="btn btn-danger"><i class="md md-clear"></i></button>
			                 				<input type="hidden" value="${met.dId}" name="dId" />
			                 			</td>
			                 			<td style="display: none;">
			                 				<input type="hidden" value="${met.gId}" name="gId" />
