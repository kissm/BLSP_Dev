...
<body>
	<div class="card">
    	<div class="card-header">
    		<%-- 根据代填中提供的材料将表名由   《珠海市建设工程（市政类）规划验收申请表》  修改为  《珠海市建设工程（市政类）规划条件核实申请表》 --%>
        	<h2>珠海市建设工程（市政类）规划条件核实申请表<small>您可通过本功能进行珠海市建设工程（市政类）规划验收申请表申报</small></h2>
	        <ul class="actions">
	            <li>
	                 	...
	                 	<tbody>
	                 		...
	                 		<tr>
	                 			...
	                 			<td style="border-left: none;border-right: none;">
	                 				<input maxlength="15" class=" base phone" type="text" name="trusteePhone" value="${formObject.trusteePhone}" />
	                 			</td>
	                 		...
	                 		<c:forEach items="${formObject.metList}" var="met" varStatus="i">
	                 			...
	                 			<c:if test="${i.index > 0}">
	                 				<tr id="${met.mId}" class="met">
			                 			<td>
			                 				<button type="button" onclick="removeMetRow('${met.mId}')" class="btn btn-danger"><i class="md md-clear"></i></button>
			                 				<input type="hidden" value="${met.mId}" name="mId" />
			                 			</td>
			                 			<td width="40px" style="border-right: none;">
			                 				<input type="hidden" value="${met.gId}" name="gId" />
	                 		...
	                 		<tr>
	                 			...
	                 			<td colspan="2" style="border-left: none;border-right: none;border-top: none;">
	                 				<div class="dtp-container dropdown">
	                 					<input type="text" class="date-picker  base" data-toggle="dropdown" aria-expanded="false" placeholder="点击填日期" value='<fmt:formatDate value="${formObject.constructDate}" pattern="yyyy-MM-dd" />' name="constructDate" >
	                 				</div>
	                 			</td>
