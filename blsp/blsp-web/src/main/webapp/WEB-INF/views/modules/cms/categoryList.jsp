	...
	<form id="listForm" method="post">
		<table id="treeTable" class="table table-striped table-bordered table-condensed">
			...
			<c:forEach items="${list}" var="tpl">
				<c:set var="noMobileCategoryFlag" value="${tpl.id ne '120' and tpl.id ne '12010' and tpl.id ne '12020' and tpl.id ne '13010' and tpl.id ne '13020' and tpl.id ne '14010' and tpl.id ne '130' and tpl.id ne '140'}"/>
