...
<%--<c:set var="ctxStaticResources" value="http://${pageContext.request.serverName}/resources/wsbs"/>--%>
<c:set var="ctxStaticResources" value="http://${pageContext.request.serverName}:${pageContext.request.serverPort}/resources/wsbs"/>
