...
<html>
	...
	<body>
		<div align="center">
			<form action="${ctx}/project/accpet/basic/" id="form" method="post">
				...
				<input type="hidden" name="url" id="url" value="next">
				...
				<input type="hidden" class="base" name="prjInstanceVo.wsbsUserName" id="wsbsUserName" value="${project.prjInstanceVo.wsbsUserName}">
				<%-- 确定提交方式 --%>
