...
<form id="searchForm"  action="${ctx}/project/accpet/material" method="post" >
								...
								<td class="text-nowrap">
									...
									<c:if test="${empty mater.value.materialAddr}">
										<button data-toggle="tooltip" data-placement="bottom" type="button" title="下载" id="download${mater.key}"
										 	type="button" class="btn btn-icon btn-file bgm-lightblue hide">
									...
									<c:if test="${!empty mater.value.materialAddr}">
										<button data-toggle="tooltip" data-placement="bottom" type="button" title="下载" id="download${mater.key}"
										 ...
										 type="button" class="btn btn-icon btn-file bgm-lightblue">
											<i class="md md-file-download"></i>
										</button>
									</c:if>
