	                ...
	                <table class="editTable" style="width: 960px;" border="0" cellspacing="0" cellpadding="0">
	                	<tbody>
		                	...
		                	<tr>
		                		...
		                		<td>
		                			<input maxlength="50" class=" base" type="text" name="promisor" value="${formObject.promisor}" />
		                		</td>
		                	</tr>
		                	<tr>
		                		<td class="title">
		                		...
		                		<td>
		                			<input maxlength="18" class=" base" type="text" name="proId" value="${formObject.proId}" />
		                		</td>
		                		<td class="title">
		                			注册执业资格
		                		</td>
		                	...
		                	<tr>
		                		...
		                		<td>
		                			<input class=" base" type="text" 
			                			...
			                			value='<fmt:formatDate value="${formObject.proDate}" 
			                			pattern="yyyy-MM-dd" />' name="proDate" />
		                		</td>
		                	</tr>
	                	</tbody>
	                </table>
