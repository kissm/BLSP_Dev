				...
				<div class="row">
					<div role="tabpanel" class="tab">
						<ul class="tab-nav" role="tablist" tabindex="3"
							...
							<li role="presentation"><a href="#tasksDiv"
									...
									<div class="col-xs-3 form-group">
										...
										<div class="fg-line disabled">
											<input disabled type="text" name="prjInstanceVo.prjCode"
												...
												class="form-control" id="projectCode" placeholder="项目编号">
										</div>
									</div>
									<div class="col-xs-3 form-group">
													...
													<tbody>
														<c:forEach
															...
															<tr>
																...
																<td><c:if test="${task.taskStatus eq 0}">暂存</c:if>
																...
																<td>
																	<a data-toggle="modal" href="javascript:void(0)" title="事项详情查看" onclick="openTask(${task.taskId},${project.prjInstanceVo.id})">查看事项</a>
																</td>
															</tr>
														</c:forEach>
													</tbody>
