	                 ...
	                 <table class="editTable" style="width: 960px;" border="0" cellspacing="0" cellpadding="0">
	                 	<tbody>
	                 		...
	                 		<tr>
	                 			...
	                 			<td colspan="2">
									<input class=" base" type="text" 
										...
										value='<fmt:formatDate value="${formObject.predictStartTime}" 
										pattern="yyyy-MM-dd" />' name="predictStartTime" />
	                 			</td>
	                 		</tr>
	                 		<tr>
	                 			<td class="title" colspan="2">
	                 			...
	                 			<td colspan="2">
									<input class=" base" type="text" 
										onClick="WdatePicker()" placeholder="点击填日期" 
										value='<fmt:formatDate value="${formObject.predictEndTime}" 
										pattern="yyyy-MM-dd" />' name="predictEndTime" />
	                 			</td>
	                 		</tr>
	                 		<tr>
	                 			<td class="title" colspan="2">
	                 		...
	                 		<tr id="bui" class="bui" name="buiTr">
	                 			<td>
	                 				<button type="button" onclick="addRow('bui')" class="btn btn-primary"><i class="md add"></i></button>
	                 			</td>
	                 			<td>
	                 		...
	                 		<c:forEach items="${formObject.buiList}" var="bui" varStatus="i">
			                 	...
			                 	<c:if test="${i.index > 0}">
	                 				<tr id="${bui.bId}" class="bui">
			                 			<td>
			                 				<button type="button" onclick="removeRow('${bui.bId}')" class="btn btn-danger"><i class="md minus"></i></button>
			                 				<input type="hidden" value="${bui.bId}" name="bId" />
			                 			</td>
			                 			<td style="display: none;">
			                 				<input type="hidden" value="${bui.qId}" name="qId" />
