	...
	$(document).ready(function() {
		...
		$(".sort-column").each(function(){
			if ($(this).hasClass(orderBy[0])){
				orderBy[1] = orderBy[1]&&orderBy[1].toUpperCase()=="DESC"?"more":"less";
				$(this).html('<a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">'+$(this).html()+'</span><span class="md icon md-expand-'+orderBy[1]+'"></span></a>');
			}
		});
