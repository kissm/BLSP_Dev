 ...
 * 
 */
package com.framework.osp.modules.gen.web;
...
import com.framework.osp.modules.gen.service.GenSchemeService;
import com.framework.osp.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.framework.osp.modules");
		}
