 ...
 * 
 */
public class SelectByEntitySelectiveElementGenerator extends
		AbstractXmlElementGenerator {

	public SelectByEntitySelectiveElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute(
				"id", SelectByEntitySelectiveMethodGenerator.METHOD_NAME)); //$NON-NLS-1$
