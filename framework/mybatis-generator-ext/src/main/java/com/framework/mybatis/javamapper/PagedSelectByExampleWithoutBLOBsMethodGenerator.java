 ...
 * 
 */
public class PagedSelectByExampleWithoutBLOBsMethodGenerator extends
		AbstractJavaMapperMethodGenerator {

	public static String METHOD_NAME = "pagedSelectByExample";

	public PagedSelectByExampleWithoutBLOBsMethodGenerator() {
		super();
	}
