 ...
 * 
 */
public class PagedSelectByEntityWithoutBLOBsElementGenerator extends
		AbstractXmlElementGenerator {

	public PagedSelectByEntityWithoutBLOBsElementGenerator() {
		super();
	}
	...
	public void addElements(XmlElement parentElement) {
		...
		answer.addAttribute(new Attribute(
				"id", PagedSelectByEntityWithoutBLOBsMethodGenerator.METHOD_NAME)); //$NON-NLS-1$
