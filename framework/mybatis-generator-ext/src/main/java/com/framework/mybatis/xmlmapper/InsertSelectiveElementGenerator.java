 ...
 * 
 */
public abstract class InsertSelectiveElementGenerator extends
    ...
    public void addElements(XmlElement parentElement,String idName) {
        XmlElement answer = new XmlElement("insert"); //$NON-NLS-1$

        answer.addAttribute(new Attribute("id", idName)); //$NON-NLS-1$
...
//        selectKeyElement.addAttribute(new Attribute("keyProperty",introspectedTable.getPrimaryKeyColumns().get(0).getJavaProperty()));
//        selectKeyElement.addAttribute(new Attribute("resultType","String"));
//        selectKeyElement.addAttribute(new Attribute("order","BEFORE"));
//        sb.append("select  replace(uuid(),'-','')   from dual");
//        selectKeyElement.addElement(new TextElement(sb.toString()));
