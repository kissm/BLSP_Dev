...
/**
* @param in config filename
*/
	public IniFileReader(InputStream in) throws FileNotFoundException, IOException
	{
...
*/
	...
	private void loadFromFile(InputStream in) throws FileNotFoundException, IOException
	{
//		FileReader fReader;
