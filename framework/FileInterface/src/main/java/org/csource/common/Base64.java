...
public class Base64 {
	...
	private void init(char chPlus, char chSplash, char chPad) {
		...
		java.util.Arrays.fill(charToPad, chPad);
	}
	...
	public byte[] decodeAuto(String s) {
		...
		if (nRemain == 0) {
			...
			return decode(s + new String(charToPad, 0, 4 - nRemain));
		}
	}
	...
	public static void show(byte[] b) {
		...
		for (byte element : b) {
			...
			System.out.print(Integer.toHexString(element & 0xFF).toUpperCase() + " ");
			count++;
