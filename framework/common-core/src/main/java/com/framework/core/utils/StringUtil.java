...
public class StringUtil {
    ...
    public static int subStringStartNum(String str){
		int startNum = 0;
		if(str != null && !"".equals(str)){
			if(str.contains("-")){
				...
				if(start.contains("千")){
					String sNum = start.substring(0, start.indexOf("千"));
					sNum = sNum + "000";
					startNum = Integer.parseInt(sNum);
				}else if(start.contains("万")){
					String sNum = start.substring(0, start.indexOf("万"));
					sNum = sNum + "0000";
					startNum = Integer.parseInt(sNum);
				}else if(start.contains("千万")){
					String sNum = start.substring(0, start.indexOf("千万"));
					sNum = sNum + "0000000";
					startNum = Integer.parseInt(sNum);
				}else if(start.contains("亿")){
					String sNum = start.substring(0, start.indexOf("亿"));
					sNum = sNum + "00000000";
					startNum = Integer.parseInt(sNum);
				}
			}else{
				if(str.contains("千")){
					...
					String sNum = str.substring(0, str.indexOf("亿"));
					sNum = sNum + "00000000";
					startNum = Integer.parseInt(sNum);
				}
			}
    ...
    public static int subStringEndNum(String str){
		int endNum = 0;
		if(str != null && !"".equals(str)){
			if(str.contains("-")){
				...
				if(end.contains("千")){
					String sNum = end.substring(0, end.indexOf("千"));
					sNum = sNum + "000";
					endNum = Integer.parseInt(sNum);
				}else if(end.contains("万")){
					String sNum = end.substring(0, end.indexOf("万"));
					sNum = sNum + "0000";
					endNum = Integer.parseInt(sNum);
				}else if(end.contains("千万")){
					String sNum = end.substring(0, end.indexOf("千万"));
					sNum = sNum + "0000000";
					endNum = Integer.parseInt(sNum);
				}else if(end.contains("亿")){
					String sNum = end.substring(0, end.indexOf("亿"));
					sNum = sNum + "00000000";
					endNum = Integer.parseInt(sNum);
				}
			}else{
				if(str.contains("千")){
					String sNum = str.substring(0, str.indexOf("千"));
					sNum = sNum + "000";
					endNum = Integer.parseInt(sNum);
				}else if(str.contains("亿")){
					String sNum = str.substring(0, str.indexOf("亿"));
