...
PDFJS.imageResourcesPath = ctxStaticModern+'/weboffice/pdf.js/images/';
  PDFJS.workerSrc = ctxStaticModern+'/weboffice/build/pdf.worker.js';
  PDFJS.cMapUrl = ctxStaticModern+'/weboffice/web/cmaps/';
